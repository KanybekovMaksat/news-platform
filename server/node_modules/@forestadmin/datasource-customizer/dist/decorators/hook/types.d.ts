...
export type HookHandler<C extends HookContext<S, N>, R = void, S extends TSchema = TSchema, N extends TCollectionName<S> = TCollectionName<S>> = (context: C) => Promise<R> | R;
export type HookType<P extends HookPosition = HookPosition> = Extract<keyof HooksContext[P], string>;
export type HookPosition = Extract<keyof HooksContext, string>;
export type HooksContext<S extends TSchema = TSchema, N extends TCollectionName<S> = TCollectionName<S>> = {
    Before: {
